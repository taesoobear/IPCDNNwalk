...
namespace RE_
{
  ...
  Ogre::Entity* createPlane2(const char* id, m_real width, m_real height, int xsegment, int ysegment, int texSegx, int texSegy);
  Ogre::Entity* createPlane(const char* id, m_real width, m_real height, int xsegment, int ysegment);
