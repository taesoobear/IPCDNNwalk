...
-----------------------------------------------------------------------------
*/
#ifndef __SkinSubEntity_H__
#define __SkinSubEntity_H__
#ifndef NO_OGRE
...
namespace Ogre {
	...
	class SkinEntity;
    /** Utility class which defines the sub-parts of an SkinEntity.
        @remarks
            Just as meshes are split into submeshes, an SkinEntity is made up of
            potentially multiple SubMeshes. These are mainly here to provide the
            link between the Material which the SkinSubEntity uses (which may be the
            default Material for the SubMesh or may have been changed for this
            object) and the SubMesh data.
        @par
            The SkinSubEntity also allows the application some flexibility in the
            material properties for this section of a particular instance of this
            Mesh, e.g. tinting the windows on a car model.
        @par
            SkinSubEntity instances are never created manually. They are created at
            the same time as their parent SkinEntity by the SceneManager method
            createEntity.
    */
    class SkinSubEntity: public Renderable
    {
        // Note no virtual functions for efficiency
        friend class SkinEntity;
        friend class SceneManager;
		friend class SkinnedMeshLoader;
    protected:
        /** Private constructor - don't allow creation by anybody else.
        */
        SkinSubEntity(SkinEntity* parent, SubMesh* subMeshBasis);

        /** Private destructor.
        */
        virtual ~SkinSubEntity();

        /// Pointer to parent.
        SkinEntity* mParentEntity;

        /// Name of Material in use by this SkinSubEntity.
        ...
        /// Is this SkinSubEntity visible?
        bool mVisible;

		/// The LOD number of the material to use, calculated by SkinEntity::_notifyCurrentCamera
        ...
        /** Internal method for preparing this SkinEntity for use in animation. */
    ...
    public:
        ...
        */
        ...
        /** Sets the name of the Material to be used.
            @remarks
                By default a SkinSubEntity uses the default Material that the SubMesh
        ...
        */
        ...
        /** Tells this SkinSubEntity whether to be visible or not. */
        virtual void setVisible(bool visible);

        /** Returns whether or not this SkinSubEntity is supposed to be visible. */
        ...
        */
		...
		/** Accessor to get parent SkinEntity */
		SkinEntity* getParent(void) const { return mParentEntity; }
        ...
        */
        ...
        @remarks
            ...
            via SkinEntity::addSoftwareAnimationRequest.
        @note
