...
-----------------------------------------------------------------------------
*/
#ifndef __SkinSkinEntity_H__
#define __SkinSkinEntity_H__
#ifndef NO_OGRE
...
namespace Ogre {
	...
	*/
	class SkinEntity: public MovableObject, public Resource::Listener
	{
		// Allow SkinEntityFactory full access
		friend class SkinEntityFactory;
		friend class SkinSubEntity;
	public:
		typedef std::set<SkinEntity*> SkinEntitySet;
	...
	public:
		...
		*/
		SkinEntity( const String& name, MeshPtr& mesh);
		...
		*/
		typedef std::vector<SkinSubEntity*> SkinSubEntityList;
		...
		/** Internal method - given vertex data which could be from the Mesh or
		any SubMesh, finds the corresponding SkinSubEntity. */
		SkinSubEntity* findSkinSubEntityForVertexData(const VertexData* orig);
		...
		* other Entities.
		*/
		SkinEntitySet* mSharedSkeletonEntities;
		...
		*/
		typedef std::vector<SkinEntity*> LODSkinEntityList;
		LODSkinEntityList mLodSkinEntityList;
		...
		*/
		...
		void buildSkinSubEntityList(MeshPtr& mesh, SkinSubEntityList* sublist);
	...
	protected:
		...
		/** Nested class to allow SkinEntity shadows. */
		class SkinEntityShadowRenderable : public ShadowRenderable
		{
		protected:
			SkinEntity* mParent;
			...
			/// Link to SkinSubEntity, only present if SkinSubEntity has it's own geometry
			SkinSubEntity* mSkinSubEntity;


		public:
			SkinEntityShadowRenderable(SkinEntity* parent,
				HardwareIndexBufferSharedPtr* indexBuffer, const VertexData* vertexData,
				bool createSeparateLightCap, SkinSubEntity* subent, bool isLightCap = false);
			~SkinEntityShadowRenderable();
	...
	public:
		...
		*/
		SkinSubEntity* getSkinSubEntity(unsigned int index) const;

		/** Gets a pointer to a SubEntity by name
		@remarks - names should be initialized during a Mesh creation.
		*/
		SkinSubEntity* getSkinSubEntity( const String& name ) const;
		...
		*/
		SkinEntity* clone( const String& newName ) const;
		...
		*/
        ...
        @remarks
			...
			Mesh::getLodLevel.
        */
        SkinEntity* getManualLodLevel(size_t index) const;
		...
		*   Skeleton.
		*/
		void shareSkeletonInstanceWith(SkinEntity* SkinEntity);
		...
		*/
		inline const SkinEntitySet* getSkeletonInstanceSharingSet() const { return mSharedSkeletonEntities; }
	...
	/** Factory object for creating SkinEntity instances */
	class SkinEntityFactory : public MovableObjectFactory
	{
	protected:
