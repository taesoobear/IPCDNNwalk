...
#define TPROS_INT( a ) ( ( ( a ) > 0.0 ) ? ( (int) ( (a)+0.5 ) ) : ( (int) ( (a)-0.5 ) ) ) 
#define TPROS_MIN( a , b ) ( ( a ) < ( b ) ? ( a ) : ( b ) ) 
#define TPROS_MAX( a , b ) ( ( a ) > ( b ) ? ( a ) : ( b ) ) 
#ifndef TPROS_PI                    
#define TPROS_PI   3.14159
#endif
#define	TPROS_STPI	2.50663 		/* sqrt ( 2*TPROS_PI ) */
#define	TPROS_LTPI	1.83788 		/* log ( 2*TPROS_PI ) */
#define	TPROS_FLUSH	fflush( stdout ) ; 
...
double ****dmatrix4( int   , int , int , int , int , int , int , int ) ;
