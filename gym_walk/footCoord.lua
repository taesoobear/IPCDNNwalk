...
input={
	skel="work/taesooLib/Resource/motion/locomotion_hyunwoo/hyunwoo_lowdof_T.wrl",
	mot="work/taesooLib/Resource/motion/locomotion_hyunwoo/hyunwoo_lowdof_T_locomotion_hl.dof",
	motionFrameRate=30,
	limbs={
	...
	jump={
		...
		mot="work/taesooLib/Resource/motion/locomotion_hyunwoo/hyunwoo_lowdof_T_jump3.dof",
	...
	turn={
		mot="work/taesooLib/Resource/motion/locomotion_hyunwoo/hyunwoo_lowdof_T_wd2_2foot_walk_turn2.dof",
		--              89                 123 
		contacts={
