...
RBDL_DLLAPI void jcalc (
  ...
  if (model.mJoints[joint_id].mJointType == JointTypeRevoluteX) {
	...
	//model.c_J[joint_id] == model.multdof3_S_o[joint_id] * Vector3d(qdot0, qdot1, qdot2);
    model.c_J[joint_id].set(
	...
	if(model.calculate_S_o)
	{
        model.multdof3_S_o[joint_id](0, 0) = -c1 * c2 * qdot2 + s1 * s2 * qdot1;
        model.multdof3_S_o[joint_id](0, 1) = - s2 * qdot2;
        model.multdof3_S_o[joint_id](1, 0) = c1 * qdot1;
        model.multdof3_S_o[joint_id](2, 0) = -s1 * c2 * qdot1 - c1 * s2 * qdot2;
        model.multdof3_S_o[joint_id](2, 1) = c2 * qdot2;
	}
	//model.c_J[joint_id] == model.multdof3_S_o[joint_id] * Vector3d(qdot0, qdot1, qdot2);
