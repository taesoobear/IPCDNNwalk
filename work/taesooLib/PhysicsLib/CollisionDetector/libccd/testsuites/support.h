...
#define CCD_OBJ_CAP 4
#define CCD_OBJ_GENERAL 5  // plug-in structure by taesoo.
...
struct _ccd_general_t {
    __CCD_OBJ__
	void (*ccdSupport)(const void *_obj, const ccd_vec3_t *_dir, ccd_vec3_t *v);
};
typedef struct _ccd_general_t ccd_general_t;
...
#define CCD_CYL(name) \
    ccd_cyl_t name = { .type = CCD_OBJ_CYL, \
                       ...
                       .height = 0. }
#define CCD_CAP(name) \
    ccd_cap_t name = { .type = CCD_OBJ_CAP, \
                       .pos  = { .v = { 0., 0., 0. } }, \
                       .quat = { .q = { 0., 0., 0., 1. } }, \
						._data=NULL,\
                       .radius = 0., \
...
#define CCD_GEN(name) \
    ccd_general_t name = { .type = CCD_OBJ_GENERAL, \
                       .pos  = { .v = { 0., 0., 0. } }, \
                       .quat = { .q = { 0., 0., 0., 1. } }, \
						._data=NULL,\
						.ccdSupport=NULL}
