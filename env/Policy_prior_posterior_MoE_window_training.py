...
class SRBPolicy(ActorCriticPolicy):
    ...
    def _build(self, lr_schedule: Schedule) -> None:
        ...
        self.log_std = nn.Parameter(torch.full((self.continuous_dim,), -2.0))  # -1.8:0.1653 试一试 -2.3: 0.1, -2.9: 0.055
    ...
    def evaluate_actions(self, obs: torch.Tensor, actions: torch.Tensor) -> Tuple[torch.Tensor, torch.Tensor, torch.Tensor]:
        ...
        # supervised loss
        weight_start_timestep = int(0)  # int(1e7)
        weight_end_timestep = int(1.5e7)
        ...
        ce_loss = next_feet_ce_loss*(0.03+0.1*weight_ratio)  # (0.01 + 0.19*weight_ratio)
        ...
        ce_loss = ce_loss+regularization_loss*0.001  # (0.1+0.1*weight_ratio)
