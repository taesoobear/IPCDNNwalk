...
class FullbodyVAEEncoder(nn.Module):
    def __init__(self, state_dim, full_body_obs_dim, hidden_dim=256, latent_dim=32, sigma_p=0.3):
...
class FullbodyVAEDecoder(nn.Module):
    def __init__(self, state_size, output_size, hidden_dim=256, latent_size=32, sigma_pi=0.05):
